...
| Mower control | ✅ | Matter `vacuum` is read-only; MQTT adds Start/Dock, model-dependent Pause and 1/3/6-hour timed starts |
...
| Native mower control | ✅ | Built into add-on 0.3.0 with one shared device and timed starts; no custom integration |
